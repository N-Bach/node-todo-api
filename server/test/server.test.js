...
describe('PATCH /todos/id', () => {
  ...
  it('should clear clompletedAt when todo is not complete', done => {
    var hexId = todos[1]._id.toHexString();
    var text = 'new text';
...
describe('POST /users', () => {
  ...
  it('should not create user when email in use', done => {
    var email = 'hikaru@gmail.com';
    var password = 'lkdjoi28gdg';
